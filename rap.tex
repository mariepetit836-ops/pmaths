...
De façon graphique, on observe que, pour $a\geq3$, la fonction oscille entre 2 points. Pour trouver ces points, il faut déterminer les points fixes de la fonction $f∘f$.\\

On fait donc $f∘f$ :
$$f∘f=a(ax_n(1-x_n))(1-(ax_n(1-x_n)))$$
On obtient $$f∘f=a^2x_n(1-x_n)-a^3(x_n)^2(1-x_n)^2$$
On cherche la d\'eriv\'ee de $f∘f$:
$$(f∘f)'=a^2(1-2x_n+a2x_n+2a(x_n)^2)$$
En cherchant les points fixes de $(f∘f)'$, on a :\\
