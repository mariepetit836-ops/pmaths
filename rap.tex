...
CONST x = 0.5; //arbitraire
	n10 = 25; 
	n20 = 10;
	amax = 4;
	amin = 2.5;  //pr̬s de 3 pour mieux voir la bifurcation
	na = 1000;

function transitoire(a, x : Real; n1 : Word) : Real;
var i : Word;
begin
	for i:=1 to n1 do
		x:=a*x*(1-x);
...
procedure varierX(a, x : Real; n2 : Word);
var i : Word;
begin
	for i:=1 to n2 do
	begin
...
procedure varierA(x, amax, amin : Real; na, n1, n2 : Word);	
var i : Word;
	da, a : Real;
begin
	da:=(amax-amin)/(na-1);
	...
	begin
		a:=amin+(i-1)*da;
		varierX(a, transitoire(a, x, n1), n2);
	end
end;

begin
	varierA(x, amax, amin, na, n10, n20);
end.

\end{verbatim}


Code permettant d'obtenir le diagramme de bifurcation, c'est-\`a-dire celui donnant les valeurs des points fixes en fonction de $a$.
...
\begin{itemize}
	...
	\item\href{https://www.youtube.com/watch?v=ovJcsL7vyrk}{lien d'une vid\'eo YouTube qui nous a permit de bien comprendre comment fonctionne logistic map}
